...
function App() {
    ...
    return (
        <>
            {/* 하이퍼 링크 : Nav.Link는 다른 페이지로 이동할 때 사용됩니다. */}
            ...
            <NavDropdown title={`기본 연습`}>
                ...
                <NavDropdown.Item onClick={() => navigate(`/element`)}>원소 1개</NavDropdown.Item>
                <NavDropdown.Item onClick={() => navigate(`/element/list`)}>원소 목록</NavDropdown.Item>
            </NavDropdown>
        </>
    );
}
